...
export default function App() {
  ...
  const { 
    serverStatus, checkServerStatus, setCameraData, setVideoDimensions, 
    setActiveTool, setIsCropping, activeSplatUrl, setIsAppLoading,
    colorScheme, primaryColor, autosave, saveCurrentProject, backendUrl
  } = useStore();
  ...
  const handleOpenProject = (project: Project) => {
    ...
    const camerasUrlRaw = project.cameras_url || `${backendUrl}/api/projects/${project.id}/cameras`;
    const camerasUrl = camerasUrlRaw.includes('http') ? camerasUrlRaw : `${backendUrl}${camerasUrlRaw}`;
